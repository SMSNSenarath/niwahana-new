                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            <table class="invoice">
                                                <tbody><tr>
                                                    <td>Worker Name : ${worker}<br>Worker Contact No : ${phone}<br>Reference No #${receiptNo}<br>${`${today.getDate()}.${today.getMonth()}.${today.getFullYear()}`}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td>Fee per day</td>
                                                                <td class="alignright">LKR ${fee}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Days</td>
