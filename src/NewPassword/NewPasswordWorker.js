...
import { newPasswordWorker } from "../actions/authActions.js";
import axios from "axios";

class NewPasswordWorker extends Component {
  constructor() {
    super();
    this.state = {
      email: "",
  ...
  onSubmit = (e) => {
    ...
    axios
      ...
      .then((window.location = "/worker-login"))
...
NewPasswordWorker.propTypes = {
  newPasswordWorker: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { newPasswordWorker })(
  NewPasswordWorker
);
